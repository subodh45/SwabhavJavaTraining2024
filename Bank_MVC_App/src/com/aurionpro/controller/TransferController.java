	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{   System.out.print("got receiver account ");
			...
			if(balance >= amount)
			{
				...
				dispatcher = request.getRequestDispatcher("CustomerPortal/Transaction.jsp");
			...
			{
				request.setAttribute("TransferFailed","Invalid sender ID.");
				dispatcher = request.getRequestDispatcher("CustomerPortal/Transaction.jsp");
		...
		else
		{
			...
			request.setAttribute("TransferFailed","Invalid receiver ID.");
			dispatcher = request.getRequestDispatcher("CustomerPortal/Transaction.jsp");
