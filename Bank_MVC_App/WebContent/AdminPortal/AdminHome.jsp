...
<div class="container">
    ...
    <form action="AdminPortal/AddCustomer.jsp">
        <button type="submit">Add New Customer</button>
    </form>
    <form action="AdminPortal/AddAccount.jsp">
...
<%
 if(request.getParameter("logout") != null) {
        ...
        response.sendRedirect("http://localhost:8080/Bank_MVC_App/Home.jsp"); // Redirect to Home page
 }
%>
