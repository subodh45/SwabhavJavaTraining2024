    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link" href="AdminPortal/AdminLogin.jsp" style="text-decoration: none;">Admin Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="CustomerPortal/CustomerLogin.jsp" style="text-decoration: none;">Customer Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="CustomerSignup.jsp" style="text-decoration: none;">Contact Us</a>
                </li>
                <li class="nav-item">
